...
import styles from './DustNoise.less';
...
@Form.create()
class DustNoise extends PureComponent {
  ...
  render() {
    ...
    const columns = [
      ...
      },
      {
        ...
        render: (record) => (
          <Fragment>
            <Link to={`/deviceMonitor/dustNoiseEdit/${record.key}`}>编辑</Link>
        ...
        <Card bordered={false}>
          <div className={styles.tableList}>
            ...
            <div className={styles.tableListOperator}>
              <Link to="/deviceMonitor/dustNoiseCreate">
