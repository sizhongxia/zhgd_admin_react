...
import styles from './Towercrane.less';
...
@connect(({ towercrane, loading }) => ({
  towercrane,
  loading: loading.effects['towercrane/fetch']
}))
@Form.create()
class Towercrane extends PureComponent {
  ...
  showReceiptPicModel = (current) => {
    ...
    new Promise((resolve) => {
      dispatch({
        type: 'towercrane/getReceiptByUuid',
        payload: {
          resolve,
          uuid: current.key,
        }
  ...
  render() {
    ...
    const columns = [
      ...
      },
      {
        ...
        render: (record) => (
          <Fragment>
            <Link to={`/deviceMonitor/towercraneEdit/${record.key}`}>编辑</Link>
        ...
        <Card bordered={false}>
          <div className={styles.tableList}>
            ...
            <div className={styles.tableListOperator}>
              <Link to="/deviceMonitor/towercraneCreate">
