...
@connect(({ elevator, loading }) => ({
  elevator,
  loading: loading.effects['elevator/fetch']
}))
@Form.create()
class Elevator extends PureComponent {
  ...
  showReceiptPicModel = (current) => {
    ...
    new Promise((resolve) => {
      dispatch({
        type: 'elevator/getReceiptByUuid',
        payload: {
          resolve,
          uuid: current.key,
        }
  ...
  render() {
    ...
    const columns = [
      ...
      },
      {
        ...
        render: (record) => (
          <Fragment>
            <Link to={`/deviceMonitor/elevatorEdit/${record.key}`}>编辑</Link>
        ...
        <Card bordered={false}>
          <div className={styles.tableList}>
            ...
            <div className={styles.tableListOperator}>
              <Link to="/deviceMonitor/elevatorCreate">
