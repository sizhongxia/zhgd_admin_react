...
import styles from './UnloadingPlatform.less';
...
@connect(({ unloadingPlatform, loading }) => ({
  unloadingPlatform,
  loading: loading.effects['unloadingPlatform/fetch']
}))
@Form.create()
class UnloadingPlatform extends PureComponent {
  ...
  showReceiptPicModel = (current) => {
    ...
    new Promise((resolve) => {
      dispatch({
        type: 'unloadingPlatform/getReceiptByUuid',
        payload: {
          resolve,
          uuid: current.key,
        }
  ...
  render() {
    ...
    const columns = [
      ...
      },
      {
        ...
        render: (record) => (
          <Fragment>
            <Link to={`/deviceMonitor/unloadingPlatformEdit/${record.key}`}>编辑</Link>
        ...
        <Card bordered={false}>
          <div className={styles.tableList}>
            ...
            <div className={styles.tableListOperator}>
              <Link to="/deviceMonitor/unloadingPlatformCreate">
...
export default UnloadingPlatform;
