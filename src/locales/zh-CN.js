export default {
  "app.name": "一通无限",
  "app.desc.short": "一通无限工地运营管理平台",
  "app.copyright": "Copyright 2018",
  "navBar.lang": "语言",
  "app.placeholder": "占位文字",

  "menu.home": "首页",
  
  "menu.construction": "工地项目",
  "menu.construction.constructionList": "工地信息列表",
  "menu.construction.loginaccount": "工地账号列表",
  "menu.construction.constructionCreate": "新建工地信息",
  "menu.construction.constructionEdit": "修改工地信息",

  "menu.deviceMonitor": "监控设备",
  "menu.deviceMonitor.towercrane": "塔机",
  "menu.deviceMonitor.elevator": "升降机",
  "menu.deviceMonitor.unloadingPlatform": "卸料平台",
  "menu.deviceMonitor.dustNoise": "扬尘噪音",
  "menu.deviceMonitor.fogGun": "雾炮喷淋",
  "menu.deviceMonitor.video": "视频",
  "menu.deviceMonitor.smoke": "烟感",
  "menu.deviceMonitor.energy": "能源",
  "menu.deviceMonitor.personPosition": "人员定位",
  "menu.deviceMonitor.infraredRadiation": "红外对射",
  "menu.deviceMonitor.gasDetection": "气体检测",
  "menu.deviceMonitor.iris": "虹膜一体机",
  "menu.deviceMonitor.electricity": "强电检测",
  "menu.deviceMonitor.electric": "电表",

  "menu.company": "企业信息",
  "menu.company.fiveEnter": "单位列表",
  "menu.company.department": "单位部门",
  "menu.company.post": "部门岗位",

  "menu.jurisdiction": "权限管理",
  

  "menu.jurisdiction.department": "部门管理",
  "menu.jurisdiction.role": "角色管理",

  "menu.system": "系统管理",
  "menu.system.logs": "系统日志",
  "menu.system.dictionary": "系统字典",
  "menu.system.area": "基础区域",
  ...
  "app.login.input.username.placeholder": "请输入账号",
  "app.login.input.password.placeholder": "请输入密码",
  "app.login.input.mobile.placeholder": "请输入手机号",
  "app.login.input.message-invalid-required": "必填项",
  "app.login.input.message-invalid-wrong-mobile": "请输入正确的手机号",
